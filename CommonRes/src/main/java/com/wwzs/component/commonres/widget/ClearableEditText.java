...
public class ClearableEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.publicClearableEditText);

        switch (typedArray.getInteger(R.styleable.publicClearableEditText_publicClearButtonMode, 0)) {
            case 1:
        ...
        int clearButton = typedArray.getResourceId(R.styleable.publicClearableEditText_publicClearButtonDrawable, android.R.drawable.ic_delete);
        typedArray.recycle();
