    ...
    public Request onHttpRequestBefore(Interceptor.Chain chain, Request request) {
        ...
        if (request.method().equals("GET")) {
            HttpUrl httpUrl = request.url()
                    .newBuilder()
                    .addQueryParameter("coid", DataHelper.getStringSF(context, "coid"))
                    .addQueryParameter("usid", DataHelper.getStringSF(context, "usid"))
                    .addQueryParameter("userid", DataHelper.getStringSF(context, "uid"))
                    .addQueryParameter("leid", DataHelper.getStringSF(context, "leid"))
                    .build();
