...
import com.wwzs.component.commonsdk.utils.LogUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
     ...
     * @param tag
     * @param lines
     * @param withLineSize 为 {@code true} 时, 每行的信息长度不会超过150, 超过则自动换行
     */
    private static void logLines(String tag, String[] lines, boolean withLineSize) {
        for (String line : lines) {
            int lineLength = line.length();
            int MAX_LONG_SIZE = withLineSize ? 150 : lineLength;
