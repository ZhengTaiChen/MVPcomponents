...
public class ArmsUtils {
     ...
     * @param string
     */
    public static void makeText(Context context, String string, @NonNull int gravity) {
        if (mToast == null) {
            mToast = Toast.makeText(context, string, Toast.LENGTH_SHORT);
    ...
    private static final int mToolbarHeight = 45;
     ...
     * @param mContext
     */
    public static void setImmerseLayout(View view, Activity mContext) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            try {
                if (mParent instanceof ConstraintLayout) {
                    view.setLayoutParams(new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_PARENT, statusBarHeight + ArmsUtils.dip2px(mContext, mToolbarHeight)));
                } else if (mParent instanceof LinearLayout) {
                    view.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, statusBarHeight + ArmsUtils.dip2px(mContext, mToolbarHeight)));
                } else if (mParent instanceof FrameLayout) {
                    view.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, statusBarHeight + ArmsUtils.dip2px(mContext, mToolbarHeight)));
                } else if (mParent instanceof RelativeLayout) {
                    view.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, statusBarHeight + ArmsUtils.dip2px(mContext, mToolbarHeight)));
                }
