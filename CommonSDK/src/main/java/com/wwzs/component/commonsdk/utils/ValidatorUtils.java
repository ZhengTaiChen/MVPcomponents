...
public class ValidatorUtils {
     ...
     * 正则表达式：验证账号
     */
    public static final String REGEX_ACCOUNT = "^[a-zA-Z0-9]\\w{2,12}$";
     ...
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,3,5-8])|(18[0-9])|(19[0-9])|(147))\\d{8}$";
...
//    public static final String REGEX_ID_CARD = "(^\\d{18}$)|(^\\d{15}$)";
    ...
    public static String replacePhone( String phone) {
        ...
        return phone.replaceAll(REGEX_PHONE, "$1****$2");
    }
